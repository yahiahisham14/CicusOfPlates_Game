...
public class FirstPlayer extends User implements Serializable {

	// Player 1 Object.(Singleton)
	private static FirstPlayer playerOne;

	private FirstPlayer(String name) {
		this.playerName = name;
		this.id = 1;
		this.playerScore=0;
		this.cargo = new ArrayList<Plate>();
		this.xCoordinate = 10;
	...
	public static User createUser(String name) {
		if (playerOne == null) {
			playerOne = new FirstPlayer(name);
		}

		return playerOne;
	}

	// used to add every plate on the top of the stack
	@Override
