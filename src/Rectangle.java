...
public class Rectangle extends Plate implements Serializable {

	private Random rendomGenerator =new Random();
	public Rectangle(int xCoordinate,int yCoordinate,Color col,int index){
		this.x=xCoordinate;
		this.y=yCoordinate;
		this.PlateColor=col;
		this.index=index;
		this.dx=rendomGenerator.nextInt(4);
		this.dy=1;
		this.cargoDir=0;
		this.caught=false;
		this.hight=20;
